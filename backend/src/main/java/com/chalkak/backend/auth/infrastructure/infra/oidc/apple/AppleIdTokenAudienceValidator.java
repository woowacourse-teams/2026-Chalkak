...
final class AppleIdTokenAudienceValidator implements OAuth2TokenValidator<Jwt> {

    private final String clientId;

    AppleIdTokenAudienceValidator(String clientId) {
    ...
    public OAuth2TokenValidatorResult validate(Jwt jwt) {
        ...
        OAuth2Error error = new OAuth2Error(
                ...
                "Apple ID Token audience가 허용되지 않았습니다.",
                null);
