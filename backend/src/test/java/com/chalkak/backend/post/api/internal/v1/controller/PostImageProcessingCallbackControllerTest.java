...
class PostImageProcessingCallbackControllerTest {
    ...
    void complete_authenticatedCallback_completesProcessing() throws Exception {
        ...
        verify(postImageProcessingService).completePostImageProcessing(eq(UPLOAD_ID), any(Map.class));
    }
    ...
    void fail_authenticatedCallback_failsProcessing() throws Exception {
        ...
        verify(postImageProcessingService).failPostImageProcessing(UPLOAD_ID, "UNSUPPORTED_FORMAT");
    }
    ...
    void complete_invalidSignature_returnsUnauthorized() throws Exception {
        ...
        verify(postImageProcessingService, never()).completePostImageProcessing(any(), any());
    }
    ...
    void fail_blankReason_returnsBadRequest() throws Exception {
        ...
        verify(postImageProcessingService, never()).failPostImageProcessing(any(), any());
    }
